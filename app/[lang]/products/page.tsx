...
const categories = ['All', 'Dehydrated Powders', 'Vegetable Flakes', 'Cold-Pressed Oils', 'Heritage Flours', 'Whole Spices', 'Spice Powders'];
      ...
      <section className="relative bg-[#0A0A0A] pt-44 pb-24 md:pt-52 md:pb-32 overflow-hidden">
        ...
        <div className="relative max-w-[1800px] mx-auto px-[5.128vw]">
          ...
          >
            ...
            <span className="italic text-[#C9A84C]">honestly made.</span>
          </h1>
          ...
          <div className="mt-10 flex flex-col md:flex-row md:items-end md:justify-between gap-10 max-w-6xl">
            ...
            >
              Single-ingredient powders, slow-pressed oils, stone-ground heritage flours, and freshly milled spices.
              Every product clean-label, traceable to source.
            </p>
            <div className="flex gap-8 md:gap-10 flex-shrink-0">
              {[
                { k: String(allProducts.length), l: 'Products' },
                { k: '6', l: 'Categories' },
                { k: '0', l: 'Additives' },
              ].map((s) => (
            ...
            {filtered.map((product, i) => (
              <ScrollReveal key={product.id} delay={i * 0.03}>
                <div className="group relative bg-[#0D0D0D] hover:bg-[#161616] transition-colors duration-300 h-full flex flex-col border border-transparent hover:border-[#C9A84C]/20 overflow-hidden">
                  ...
                  {/* Image */}
                  <Link href={`/products/item/${product.id}`} className="block relative aspect-square overflow-hidden bg-[#161616]">
                    <Image
                      src={product.image}
                      alt={product.name}
                      fill
                  ...
                  <div className="p-6 md:p-7 flex flex-col flex-1">
                    ...
                    <div className="flex items-baseline gap-1.5">
                      ...
                      <span className="font-sans-harvest text-[9px] tracking-[0.15em] uppercase text-[#F5F0E8]/35">/ {product.unit}</span>
                    </div>
