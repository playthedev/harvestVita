  ...
  return (
    <>
      <PageHero
        ...
        subtitle={quality.hero.subtitle}
        geometry="octahedron"
        color="#C9A84C"
        stat={quality.hero.stats}
      />
      ...
      <section className="bg-[#0D0D0D] py-24 md:py-32 relative overflow-hidden">
        ...
        >
          {quality.standardsSection.decorativeWord}
        </div>
              ...
              <div>
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <p className="font-sans-harvest text-[10px] tracking-[0.35em] uppercase text-[#C9A84C]">
                    {quality.standardsSection.label}
                  </p>
                </div>
                <h2 className="font-display font-bold text-[#F5F0E8] leading-[0.95] tracking-tight"
                  style={{ fontSize: 'clamp(2.5rem, 5vw, 4.5rem)' }}>
                  {quality.standardsSection.headingLine1}<br />
                  <span className="italic text-[#C9A84C]">{quality.standardsSection.headingHighlight}</span>
                </h2>
              </div>
              <p className="font-serif text-[#F5F0E8]/60 text-lg leading-relaxed">
                {quality.standardsSection.subtitle}
              </p>
            </div>
          </ScrollReveal>
          ...
          <ScrollReveal>
            <div className="mb-16 flex flex-col md:flex-row md:items-end md:justify-between gap-6">
              ...
              <p className="font-serif text-[#6B6456] text-base leading-relaxed max-w-sm">
                {quality.processSection.subtitle}
              </p>
            </div>
          </ScrollReveal>

          <div className="space-y-px bg-[#1C1C1C]/10 border-t border-b border-[#1C1C1C]/15">
            {quality.processSection.process.map((step, i) => (
                ...
                <div className="group relative bg-[#F5F0E8] grid md:grid-cols-12 gap-6 md:gap-8 p-8 md:p-10 hover:bg-[#EDE5D4] transition-colors overflow-hidden">
                  ...
                  <div className="md:col-span-7">
                    ...
                    <p className="mt-4 font-sans-harvest text-[10px] tracking-[0.3em] uppercase text-[#C9A84C]/60">
                      {quality.processSection.stepOfLabel.replace('{num}', step.num)}
                    </p>
                  </div>
                </div>
              </ScrollReveal>
      ...
      <CTABand
        eyebrow={quality.cta.eyebrow}
        title={quality.cta.title}
        buttonLabel={quality.cta.buttonLabel}
